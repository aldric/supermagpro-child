...
function supermag_entry_footer() {
	...
	if ( 'post' === get_post_type() ) {
		...
		if ( $tags_list ) {
			printf( '<span class="tags-links"><i class="fa fa-tags"></i>' . esc_html__( '%1$s', 'supermag' ) . '</span>', $tags_list ); // WPCS: XSS OK.
		}
	}
